/*
 * soko-properties-contact.js
 * This file handles the submission of the general contact form for Soko Properties.
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateMetaTags() {
        ...
        // Default values for the Soko Properties general contact page
        const title = "Contact Soko Properties - Get in Touch";
        const description = "Contact Soko Properties for general real estate inquiries, property listings, or support. Reach us via phone, email, or our online contact form.";
        const imageUrl = "images/shop-soko-properties.webp"; // Use the shop's default image
        const keywords = "contact Soko Properties, Soko Properties phone number, Soko Properties email, real estate agency contact, property support Kenya";
    ...
    if (generalContactForm) {
        generalContactForm.addEventListener('submit', function(event) {
            ...
            console.log('Soko Properties General Contact Form Data Submitted:', formData);

            // Simulate API call (in a real application, you would send this to a backend)
            // fetch('/api/sokoproperties-contact', {
            //     method: 'POST',
            //     headers: {
